...
import { getWhatsAppUrl, whatsappDisplayNumber } from '@/lib/contact';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 pb-28">
          ...
          >
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3 text-slate-400">
                ...
                <span>Casilda, Santa Fe, Argentina</span>
              </li>
            </ul>
          </motion.div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            {['Sitio web desarrollado por Facundo Picia'].map((link) => (
              <button
                key={link}
